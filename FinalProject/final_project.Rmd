...
based on the plot has the lambda minimum value of about 65 variables and based on the graph,
taking the lambda minimum (first dotted line on the left) has a smaller mean squared error.
